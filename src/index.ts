...
import { DefaultRegistry, startBridge, stopBridge } from "@smartcharging/scn-bridge"
import { ModuleImplementation } from "@smartcharging/scn-bridge/dist/models/bridgeConfigurationOptions"
...
yargs
    .command("mock", "Start a mock SCPI party server", (context) => {
        context
            .option("cpo", {
                alias: "c",
                boolean: true,
            ...
            .option("register-only", {
                alias: "r",
                boolean: true,
                describe: "register party to SCN then close"
            })
            .help()
    }, async (args) => {
        ...
        const registry = new DefaultRegistry(config.scn.stage)
        ...
        if (args.cpo) {
            ...
            console.log("CPO server listening for SCPI requests")
            ...
            console.log("MSP server listening for SCPI requests")
