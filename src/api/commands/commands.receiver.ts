...
import { CommandResponseType, CommandResultType, IAsyncCommand, ICommandResult } from "@smartcharging/scn-bridge/dist/models/scpi/commands";
import { IReserveNow, IStartSession } from "@smartcharging/scn-bridge/dist/models/pluggableAPI";
